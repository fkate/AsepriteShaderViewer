...
## About
Extension for Aseprite to preview sprites with custom GLSL shaders. Uses a Silk.Net / OpenGL view and local websockets to allow for cross platform compability.

## Features
- Write GLSL shaders in a ShaderToy similar fashion to preview your workspace with shaders
